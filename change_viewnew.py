...
def main(arguments):
    ...
    try:
        ...
        print('change_viewnew.py -p <project_id> -f <feed> -t <PAT>  -a <artifact_name> -g <artifact_group> -v <artifact '
              'ver> -w <view>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print(  
                'change_viewnew.py -p <project_id> -f <feed> -t <PAT>  -a <artifact_name> -g <artifact_group> -v <artifact '
                'ver> -w <view>')
            sys.exit()
